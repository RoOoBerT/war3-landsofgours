...
//===========================================================================
function Trig_AoE_Spells_Spell_Func002C takes nothing returns boolean
...
function Trig_AoE_Spells_Spell_Func006C takes nothing returns boolean
...
function Trig_AoE_Spells_Spell_Func017Func001C takes nothing returns boolean
...
function Trig_AoE_Spells_Spell_Actions takes nothing returns nothing
    ...
    if ( Trig_AoE_Spells_Spell_Func002C() ) then
    ...
    // Spells specifics
    if ( Trig_AoE_Spells_Spell_Func006C() ) then
    ...
    loop
        exitwhen bj_forLoopAIndex > bj_forLoopAIndexEnd
        if ( Trig_AoE_Spells_Spell_Func017Func001C() ) then
