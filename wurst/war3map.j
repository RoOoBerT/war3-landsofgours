...
function CreateUnitsForPlayer23 takes nothing returns nothing
    ...
    set u = CreateUnit( p, 'n00A', 916.3, -1308.5, 225.107 )
    ...
    set u = CreateUnit( p, 'n00K', 12157.4, 373.4, 7.790 )
    set u = CreateUnit( p, 'n005', 716.7, -1344.8, 231.265 )
    set u = CreateUnit( p, 'n00H', 917.0, -1970.7, 86.750 )
    set u = CreateUnit( p, 'n00K', 12034.0, 516.2, 303.627 )
    set u = CreateUnit( p, 'n00K', 14757.2, -4078.6, 192.201 )
    set u = CreateUnit( p, 'n00K', 16386.2, -2811.4, 100.253 )
    set u = CreateUnit( p, 'n00K', 16526.2, -2420.2, 98.561 )
    set u = CreateUnit( p, 'n00K', 13828.6, -3962.3, 282.247 )
    set u = CreateUnit( p, 'n00K', 10771.3, 1541.9, 44.155 )
    set u = CreateUnit( p, 'n00K', 12284.5, 2707.4, 3.318 )
    set u = CreateUnit( p, 'n00K', 14085.7, 3716.2, 306.836 )
    set u = CreateUnit( p, 'n00K', 13194.5, 1681.8, 41.156 )
    set u = CreateUnit( p, 'n00K', 16463.1, 3335.4, 298.277 )
...
function CreateNeutralPassive takes nothing returns nothing
    ...
    set u = CreateUnit( p, 'n00I', 1028.7, 12.3, 270.000 )
    set u = CreateUnit( p, 'n001', -76.6, 579.3, 270.000 )
    set u = CreateUnit( p, 'n000', -73.4, 746.0, 270.000 )
    set u = CreateUnit( p, 'n002', -77.7, 997.1, 270.000 )
    set u = CreateUnit( p, 'n005', 116.9, 568.9, 270.000 )
    set u = CreateUnit( p, 'n004', 143.3, 744.0, 270.000 )
    set u = CreateUnit( p, 'n003', 146.4, 1009.1, 270.000 )
    set u = CreateUnit( p, 'n008', 373.8, 558.8, 270.000 )
    set u = CreateUnit( p, 'n009', 676.0, 640.8, 270.000 )
    set u = CreateUnit( p, 'n00A', 684.8, 920.7, 270.000 )
    set u = CreateUnit( p, 'n007', 390.4, 748.1, 270.000 )
    set u = CreateUnit( p, 'n006', 380.0, 966.6, 270.000 )
    set u = CreateUnit( p, 'n00D', 1103.4, 28.2, 270.000 )
    set u = CreateUnit( p, 'n00O', 1164.9, 539.5, 270.000 )
    set u = CreateUnit( p, 'n00P', 1109.3, 638.3, 270.000 )
    set u = CreateUnit( p, 'n00Q', 1208.0, 641.6, 270.000 )
    set u = CreateUnit( p, 'n00R', 1241.5, 950.3, 270.000 )
    set u = CreateUnit( p, 'n00W', 1400.2, 1199.5, 270.000 )
    set u = CreateUnit( p, 'n00T', 1466.4, 675.8, 270.000 )
    set u = CreateUnit( p, 'n00U', 1474.3, 765.9, 270.000 )
    set u = CreateUnit( p, 'n00S', 1469.6, 588.2, 270.000 )
    set u = CreateUnit( p, 'n00V', 1475.4, 875.2, 270.000 )
    set u = CreateUnit( p, 'n00H', 689.5, 380.3, 270.000 )
    set u = CreateUnit( p, 'h002', 681.2, 385.6, 270.000 )
    set u = CreateUnit( p, 'n00B', 474.6, 338.2, 270.000 )
    set u = CreateUnit( p, 'n00C', 1168.9, 98.4, 270.000 )
    set u = CreateUnit( p, 'n00F', 1060.2, 177.0, 270.000 )
    set u = CreateUnit( p, 'n00G', 1203.5, 227.3, 270.000 )
