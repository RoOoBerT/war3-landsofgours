...
function CreateAllItems takes nothing returns nothing
    ...
    call CreateItem( 'I000', -3203.8, 2876.8 )
    call CreateItem( 'I001', -3262.0, 2948.3 )
    ...
    call CreateItem( 'I004', -3164.9, 2694.2 )
    call CreateItem( 'I005', -928.1, -2597.8 )
    call CreateItem( 'I005', -3129.5, 2695.7 )
    call CreateItem( 'I006', -3302.7, 2690.1 )
    call CreateItem( 'I007', -4883.4, -2026.2 )
    call CreateItem( 'I007', -3212.1, 2693.1 )
    call CreateItem( 'I008', -3257.4, 2689.2 )
    call CreateItem( 'I009', -3301.0, 2637.9 )
    call CreateItem( 'I00A', -3262.8, 2641.0 )
    call CreateItem( 'I00B', -3260.0, 2593.0 )
    ...
    call CreateItem( 'I00I', -3123.4, 2653.1 )
    call CreateItem( 'I00J', -3170.2, 2643.1 )
    call CreateItem( 'I00K', -3312.3, 2591.1 )
    call CreateItem( 'I00P', -3313.5, 2538.2 )
endfunction
...
function Trig_Command_Launch_Actions takes nothing returns nothing
    ...
    if ( Trig_Command_Launch_Func014C() ) then
        ...
        if ( Trig_Command_Launch_Func014Func002C() ) then
            ...
            call DisplayTimedTextToForce( GetForceOfPlayer(GetTriggerPlayer()), 10.00, "TRIGSTR_431" )
        endif
        return
    else
    endif
...
function Trig_Cone_Spells_Spell_Func021C takes nothing returns boolean
...
function Trig_Cone_Spells_Spell_Actions takes nothing returns nothing
    ...
    // Feu solaire
    if ( Trig_Cone_Spells_Spell_Func021C() ) then
        set udg__real_Angle = GetUnitFacing(GetTriggerUnit())
        set udg__real_AngleSpread = 360.00
        set udg__real_TimeEnd = ( udg__real_CurrentTime + 1.00 )
        set udg__point2 = GetSpellTargetLoc()
        // -
        call SaveRealBJ( 768.00, 10, GetHandleIdBJ(GetLastCreatedUnit()), udg_SpellCone_Data )
        call SaveRealBJ( 100.00, 11, GetHandleIdBJ(GetLastCreatedUnit()), udg_SpellCone_Data )
        call SaveRealBJ( 768.00, 12, GetHandleIdBJ(GetLastCreatedUnit()), udg_SpellCone_Data )
        call SaveRealBJ( 100.00, 13, GetHandleIdBJ(GetLastCreatedUnit()), udg_SpellCone_Data )
        call SaveRealBJ( 0.00, 14, GetHandleIdBJ(GetLastCreatedUnit()), udg_SpellCone_Data )
        // Graphics
        call SaveStringBJ( "Abilities\\Spells\\Items\\AIfb\\AIfbSpecialArt.mdl", 20, GetHandleIdBJ(GetLastCreatedUnit()), udg_SpellCone_Data )
        call SaveRealBJ( 0.00, 21, GetHandleIdBJ(GetLastCreatedUnit()), udg_SpellCone_Data )
        call SaveRealBJ( udg__real_CurrentTime, 22, GetHandleIdBJ(GetLastCreatedUnit()), udg_SpellCone_Data )
        call SaveRealBJ( 64.00, 23, GetHandleIdBJ(GetLastCreatedUnit()), udg_SpellCone_Data )
        // Graphics (HEAD)
        call SaveStringBJ( "Abilities\\Spells\\Items\\AIfb\\AIfbSpecialArt.mdl", 24, GetHandleIdBJ(GetLastCreatedUnit()), udg_SpellCone_Data )
        call SaveRealBJ( 0.25, 25, GetHandleIdBJ(GetLastCreatedUnit()), udg_SpellCone_Data )
        call SaveRealBJ( udg__real_CurrentTime, 26, GetHandleIdBJ(GetLastCreatedUnit()), udg_SpellCone_Data )
        call SaveRealBJ( 64.00, 27, GetHandleIdBJ(GetLastCreatedUnit()), udg_SpellCone_Data )
        // Effects
        call SaveIntegerBJ( 0, 30, GetHandleIdBJ(GetLastCreatedUnit()), udg_SpellCone_Data )
    else
    endif
